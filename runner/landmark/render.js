...
function renderCardSvg(event, content, artBuf, opts = {}) {
  ...
  return generateCard({
    ...
    stats: {
      volumeZ:            event.volumeZ || 0,
      velocityRatio:      event.velocityRatio || 0,
      noveltyCount:       event.noveltyCount || 0,
      sentimentAvg:       event.sentimentAvg || 0,
      crossClusterTopics: event.topKeywords || [],

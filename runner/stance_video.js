...
async function composeBrief(subject) {
  ...
  const prompt = [
    ...
    `declarative — state the position AND one reason. Calibrate certainty to the stated`,
    `confidence: below 50% say "I think"/"leaning"; 50-75% say it plainly; above 75% say it`,
    `firmly. No hashtags, no jargon, no "as an AI".`,
    ``,
